...
public class ChickenPack : Mgr
{
    ...
    {
        if (tutoMgr.tutoComplete1 == false && tutoMgr.nowTuto != Tutorial.Tuto_11)
        {
            //튜토리얼 중에는 드래그 불가능
            return;
        }
    ...
    public void OnMouseUp()
    {
        ...
        if (kitchenMgr.mouseArea == DragArea.Trash_Btn && tutoMgr.tutoComplete1)
        {
            //버리기 버튼처리
            Init();
