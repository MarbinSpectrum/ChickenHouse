    ...
    public override void OrderGuest(NoParaDel fun = null)
    {
        ...
        switch (requireMenu.drink)
        {
            ...
            case Drink.SuperPower:
                talkStr += "\n";
                talkStr += LanguageMgr.GetText("DOVE_SIDE_SUPERPOWER");
                break;
            case Drink.LoveMelon:
                talkStr += "\n";
                talkStr += LanguageMgr.GetText("DOVE_SIDE_LOVEMELON");
                break;
            case Drink.SodaSoda:
                talkStr += "\n";
                talkStr += LanguageMgr.GetText("DOVE_SIDE_SODASODA");
                break;
        }
        ...
        switch (requireMenu.sideMenu)
        {
            case SideMenu.ChickenRadish:
                talkStr += "\n";
                talkStr += LanguageMgr.GetText("DOVE_SIDE_RADISH");
                break;
            ...
            case SideMenu.Coleslaw:
                talkStr += "\n";
                talkStr += LanguageMgr.GetText("DOVE_SIDE_COLESLAW");
                break;
            case SideMenu.CornSalad:
                talkStr += "\n";
                talkStr += LanguageMgr.GetText("DOVE_SIDE_CORNSALAD");
                break;
            case SideMenu.FrenchFries:
                talkStr += "\n";
                talkStr += LanguageMgr.GetText("DOVE_SIDE_FRENCHFRIES");
                break;
            case SideMenu.ChickenNugget:
                talkStr += "\n";
                talkStr += LanguageMgr.GetText("DOVE_SIDE_CKICKENNUGGET");
                break;
        }
    }
